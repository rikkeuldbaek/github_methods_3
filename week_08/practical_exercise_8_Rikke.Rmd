...
#we have 600 = number of repetitions of a visual stimulus, 102 = the second dimension is the number of sensors,  251 =the third dimension is the number of time samples) 

data1 = np.load("pas_vector.npy")
