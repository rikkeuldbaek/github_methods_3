...
X_1_2_equal, y_1_2_equal = equalize_targets_binary(data_1_2, y_1_2) #make that code spinnnnn 
y_1_2_equal.shape #check that dope data out (1 dim)
X_1_2_equal.shape #check that dope data out (3 dim)

#rehape X_1_2_equal from 3D to 2D
X_1_2_equal= X_1_2_equal.reshape(198,-1) # now it's 2D
X_1_2_equal.ndim
...
scaled_X_1_2_equal # our X (standardized)
y_1_2_equal # our y
