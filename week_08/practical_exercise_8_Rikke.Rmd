...
#slope and intercept? 
intercept = logR.intercept_;print(intercept) #PRINTING INTERCEPT
slope = logR.coef_;print(slope) # printing SLOPE
```
...
from sklearn.linear_model import LogisticRegression #importing 
logR_L1 = LogisticRegression(penalty ='l1', tol = 0.01, solver = "saga", c=1) #renaming stuff for simplicity
logR_L1.fit(scaled_X_1_2, y_1_2) 

#Use the `score` method of `LogisticRegression` to find out how many labels were classified correctly. 
logR_L1.score(scaled_X_1_2, y_1_2) # 1.0 

#coefs being 0?
zeros_L1 = logR_L1.coef_[logR_L1.coef_==0]
len(zeros_L1) # her har jeg mange 0's (say whaaat ???)


#ovenstående kan ik rigtig køre, så jeg bruger L2 i stedet for (RIDGE REGRESSION)
# Do a standard `LogisticRegression` - this time use penalty 'L1' 
from sklearn.linear_model import LogisticRegression #importing 
logR_L2 = LogisticRegression(penalty ='l2') #renaming stuff for simplicity
logR_L2.fit(scaled_X_1_2, y_1_2) 

#Use the `score` method of `LogisticRegression` to find out how many labels were classified correctly. 
logR_L2.score(scaled_X_1_2, y_1_2) # 1.0 

#coefs being 0?
zeros_L2 = logR_L2.coef_[logR_L2.coef_==0]
len(zeros_L2) # i ridge regression får jeg aldrig 0, 
```
