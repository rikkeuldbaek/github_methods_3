...
The interaction in model 6, indicates that Korean men's pitch when they are polite are higher than Korean women's pitch when they are polite. Though, none of the effects are significant, thus reaching a conclusion is not possible. 
...
The summary output of model 6 shows how going from female (with an intercept of 254.193 hz) to male, the pitch of voice decreases by 117.983 hz. When going from the attitude "informal" to "polite" the pitch of voice decreases by 15.646 hz. Lastly, when going from ....... !!!!!!INTERACTION!!!!!!!!!!

However, we cannot conclude anything, since none of the effects are significant. 
...
##### Q-Q-plot of model
When comparing a Q-Q-plot from model 6 and Q-Q-plot from model 5, the values seem to fit the line slightly better for model 6. 

However, it must be stated, than none of the effects were statistically significant, thus making the model ineffectual. 
...
(Intercept)          254.193      9.654  26.330
genderM             -117.983     13.633  -8.654
attitudepol          -15.646      5.196  -3.011
genderM:attitudepol    5.781      7.856   0.736

(Intercept)  kvinde/informal =  254 hz
genderM /når vi går fra kvinde til mand = falder pitch med 117 hz
attitudepol, når vi går fra informal til polite = falder pitch med 15 hz
