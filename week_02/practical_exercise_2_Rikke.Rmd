...
attach(politeness) # attach means u don't need to do tidyverse piping, so you don't have to refer to the politeness dataset.
```
...
The distribution of the variable is positively skewed (right-skewed distribution).
...
#####F0mn variable
F0mn represents the frequency in Hertz of the voice i.e the pitch in voice in hz. This variable is numeric and the distribution of the data is bimodal. 
```{r}
#f0mn
