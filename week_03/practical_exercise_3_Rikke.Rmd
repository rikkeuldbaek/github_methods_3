...
i.When adding different types of group intercepts (random effect), I can only add two intercepts: (1|subject)+(1|trial), before the model meets singular fit issues.
...
This model has a RSS = 699.5, an AIC = 3148.4, and an R2c = 97.5. The model has a better AIC value than the other model (AIC= 3398.5), and a slightly better R2c and RSS. 
