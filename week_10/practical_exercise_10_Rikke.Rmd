...
After we performed the principal component analysis on the covariance matrix, which are sorted into the ranks of the PCAs that explains the most variance - from the covariance matrix of the PCA, we don't see any off-diagonal 

therefore, the covariance off-diagonal has been put into the
